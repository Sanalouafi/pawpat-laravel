                ...
                <table class="w-full whitespace-no-wrap">
                    ...
                    <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                        @foreach ($adoptionRequests as $adoptionRequest)
                            <tr class="text-gray-700 dark:text-gray-400">
                                    ...
                                    <div class="flex items-center text-sm">
                                        <div class="relative hidden w-8 h-8 mr-3 rounded-full md:block">
                                            <img class="object-cover w-full h-full rounded-full"
                                                src="{{ $adoptionRequest->pet->getFirstMediaUrl('pet') }}" alt=""
                                                loading="lazy" />
                                            <div class="absolute inset-0 rounded-full shadow-inner" aria-hidden="true">
                                            </div>
                                        </div>
                                        <div>
                                            <p class="font-semibold">{{ $adoptionRequest->pet->name }}</p>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-4 py-3">
                                    <div class="flex items-center text-sm">
                                        <div>
                                            <p class="font-semibold">{{ $adoptionRequest->user->name }}</p>
                                        </div>
                                        <div>
                                            <p class="font-semibold">{{ $adoptionRequest->user->cni }}</p>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td class="px-4 py-3 text-sm flex ">
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        {{-- edit --}}
                                        <a data-modal-target="edit-adoptionRequest{{ $adoptionRequest->id }}"
                                            data-modal-toggle="edit-adoptionRequest{{ $adoptionRequest->id }}" class="mr-4">
                            ...
                            <!-- Main edit modal -->
                            <div id="edit-adoptionRequest{{ $adoptionRequest->id }}" tabindex="-1" aria-hidden="true"
                                    ...
                                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                        ...
                                        <div
                                            ...
                                            <h3 class="text-xl font-semibold text-gray-900 dark:text-white">
                                                Edit adoptionRequest informations
                                            </h3>
                                            <button type="button"
                                                ...
                                                data-modal-hide="edit-adoptionRequest{{ $adoptionRequest->id }}">
