            ...
            <div
                ...
                <div class="lg:col-span-3 w-full lg:sticky top-0 text-center">
                    <div class="px-4 py-10 rounded-xl shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] relative">
                        <img src="{{ $pet->getFirstMediaUrl('pet') }}" alt="pet" class="w-4/5 rounded object-cover" />
                        <button type="button" class="absolute top-4 right-4">
                            <a href="{{ route('userPet.show', $pet->id) }}">
                ...
                <div class="lg:col-span-2">
                    ...
                    <div class="flex flex-wrap gap-4 mt-10">
                        <form action="{{route('userAdoption')}}" method="POST">
                            @csrf
                            <input type="hidden" name="pet_id" value="{{ $pet->id }}">
                            <input type="hidden" name="support_agents_id" value="{{$pet->support_agent_id}}">
