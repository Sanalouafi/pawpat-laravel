...
<head>
    ...
    <link rel="stylesheet" href="{{ URL::asset('css/supportAgent.css') }}">
</head>
...
<body>
    <div class="flex h-screen bg-gray-50 dark:bg-gray-900" :class="{ 'overflow-hidden': isSideMenuOpen }">
        ...
        <aside class="z-20 hidden w-64 overflow-y-auto bg-white dark:bg-gray-800 md:block flex-shrink-0">
            <div class="py-4 text-gray-500 dark:text-gray-400">
                <a class="ml-6 text-lg font-bold text-gray-800 dark:text-gray-200" href="{{ route('supportAgent.index') }}">
                    PawPat
                </a>
                <ul class="mt-6">
                    <li class="relative px-6 py-3">
                        <span class="absolute inset-y-0 left-0 w-1 bg-blue-900 rounded-tr-lg rounded-br-lg"
                            aria-hidden="true"></span>
                        <a class="inline-flex items-center w-full text-sm font-semibold text-gray-800 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200 dark:text-gray-100"
                            href="{{ route('supportAgent.index') }}">
                ...
                <ul>
                    <li class="relative px-6 py-3">
                        <a class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                            href="{{ route('supportAgentPet.index') }}">
                            <svg class="w-5 h-5" aria-hidden="true" fill="none" stroke-linecap="round"
                                stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
                                <path
                            ...
                            <span class="ml-4">Pet section</span>
                        </a>
                    </li>
        ...
        <div class="flex flex-col flex-1 w-full">
            <header class="z-10 py-4 bg-white shadow-md dark:bg-gray-800">
                <div
                    class="container flex items-center justify-between h-full px-6 mx-auto text-blue-900 dark:text-blue-300">
                    <!-- Mobile hamburger -->
                    ...
                    <ul class="flex items-center flex-shrink-0 space-x-6">
                        ...
                        <li class="relative">
                            <button class="align-middle rounded-full focus:shadow-outline-blue focus:outline-none"
                                ...
                                src="{{Auth::user()->supportAgent->getFirstMediaUrl('supportAgent')}}"
                                ...
                                <ul x-transition:leave="transition ease-in duration-150"
                                    ...
                                    <li class="flex">
                                        <a class="inline-flex items-center w-full px-2 py-1 text-sm font-semibold transition-colors duration-150 rounded-md hover:bg-gray-100 hover:text-gray-800 dark:hover:bg-gray-800 dark:hover:text-gray-200"
                                            href="{{ route('supportAgent.edit', Auth::user()->id) }}">
    ...
    <script>
        ...
        function previewEditImage(event, supportAgentId) {
            const input = event.target;
            const preview = document.getElementById(`preview-edit-image${supportAgentId}`);
